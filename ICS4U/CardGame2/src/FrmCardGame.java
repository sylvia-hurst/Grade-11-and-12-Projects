...
public class FrmCardGame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblResult2.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        lblResult3.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        lblResult4.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        lblResult5.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        lblCorrect.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        lblIncorrect.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        lblPercent.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        txtC1.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        getContentPane().add(txtC1);
        txtC1.setBounds(30, 190, 90, 40);

        txtC2.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        getContentPane().add(txtC2);
        txtC2.setBounds(140, 190, 90, 40);

        txtC3.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        getContentPane().add(txtC3);
        txtC3.setBounds(250, 190, 90, 40);

        txtC4.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        getContentPane().add(txtC4);
        txtC4.setBounds(360, 190, 90, 40);

        txtC5.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        getContentPane().add(txtC5);
        txtC5.setBounds(470, 190, 90, 40);

        btnH1.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        btnH2.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        btnH3.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        btnH4.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        btnH5.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        ...
        switch (turn) {
            case 0:
                ...
                //The description message updates to reflect your objective
                lblDesc.setText("Take your time to memorize the cards.");
            ...
            case 1:
                ...
                //The description message updates to reflect your objective
                lblDesc.setText("Enter your guesses. You may get a hint for each card if you wish.");
            ...
            case 2:
                ...
                //The description message updates to reflect your objective
                lblDesc.setText("Round complete. Press 'CONTINUE' to start a new round.");
